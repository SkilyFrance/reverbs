    ...
    return new Scaffold(
      ...
      body: new Container(
        ...
        child: new StreamBuilder(
          stream: FirebaseFirestore.instance.collection(widget.musicStyle).orderBy(widget.filterRecentIsChoosen == true ? 'timestamp' : 'likes', descending: true).snapshots(),
                  ...
                  new Positioned(
                    ...
                    child: new Center(
                      ...
                      child: new Column(
                        ...
                        children: [
                      new Text('No song here yet.', style: new TextStyle(color: Colors.grey,fontSize: 18.0, fontWeight: FontWeight.bold)),
                      new Text('Look another style buddy', style: new TextStyle(color: Colors.white.withOpacity(0.7),fontSize: 15.0, fontWeight: FontWeight.w600)),
                      ])),
                      ),
                    ),
                  ),
                      ...
                      children: [
                        ...
                        new Container(
                          ...
                          child: new Container(
                            ...
                            style: new TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.w600,
                            ),
                            delimiter: '  ',
                            trimLines: 2,
                                                  ...
                                                  child: new Column(
                                                    ...
                                                    children: [
                                                      new Container(
                                                        ...
                                                        width: MediaQuery.of(context).size.width,
                                                  child: new StreamBuilder(
                                                    stream: FirebaseFirestore.instance.collection(widget.musicStyle).doc(ds.data()['timestamp']).collection('comments').orderBy('timestamp', descending: false).snapshots(),
                                                    builder: (BuildContext context, snapshot) {
                                                    if(snapshot.hasError) {
                                                      return new Center(
