...
class ProjectPublicationPageState extends State<ProjectPublicationPage> {
        ...
        headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
          return <Widget> [
            new CupertinoSliverNavigationBar(
              ...
              largeTitle: new Text('Publish a project',
          ...
          child: new SingleChildScrollView(
            ...
            child: new Column(
              ...
              children: [
                ...
                new Container(
                  child: new Center(
                    child: new Text('Project context',
                ...
                new Container(
                  child: new Center(
                    child: new Text('Choose the demo',
                    style: new TextStyle(color: Colors.grey[300], fontSize: 20.0, fontWeight: FontWeight.w500),
                    ),
                  ),
                ),
